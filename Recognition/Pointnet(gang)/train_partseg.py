...
seg_classes = {'carrage_support': [0, 1], 'crane': [2, 3], 'crane_suspension_bracket': [4, 5, 6]}
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        train_acc.append(train_instance_acc.item())
        ...
        if (test_metrics['inctance_avg_iou'] >= best_inctance_avg_iou):
            ...
            test_acc.append(test_metrics['accuracy'].item())
            cls_mIoU.append(test_metrics['class_avg_iou'].item())
            inc_mIoU.append(test_metrics['inctance_avg_iou'].item())
        ...
        with open("./cls_mIoU.txt", 'w') as cls_iou:
            cls_iou.write(str(cls_mIoU))
        with open("./inc_mIoU.txt", 'w') as inc_iou:
            inc_iou.write(str(inc_mIoU))
